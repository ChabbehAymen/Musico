...
import com.example.musico.databinding.CircularMusicardItemBinding


class RandomPickerAdapter(
    private val values: List<SongStateUi>, private val context: Context
) : RecyclerView.Adapter<RandomPickerAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

        return ViewHolder(
                CircularMusicardItemBinding.inflate(
    ...
    inner class ViewHolder(binding: CircularMusicardItemBinding) : RecyclerView.ViewHolder(binding.root) {
